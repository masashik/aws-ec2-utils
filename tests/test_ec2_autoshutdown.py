...
class TestEc2Autoshutdown(unittest.TestCase):
    ...
    #     result = ec2_autoshutdown.get_instances("us-east-1")
    ...
    def test_should_shutdown_true(self):
        ...
        result = ec2_autoshutdown.should_shutdown(instance, threshold_minutes=30)
    ...
    #     ec2_autoshutdown.shutdown_instances([instance], 30, dry_run=True)
